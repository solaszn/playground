    ...
    <div className="App">
      ...
      <div className="grid grid-rows-[32px_1fr_32px] gap-10 bg-neutral-100 max-w-[1600px] mx-auto px-[60px] py-10 h-screen font-inter">
        ...
        <div className="flex justify-between h-8 text-sm">
          <div className="flex gap-1.5 px-3 py-1 border border-neutral-300 rounded-md bg-white items-center">
            <div className="text-neutral-400 flex gap-1.5 items-center">Works <LuChevronRight size={18}/> </div>
            <span className="font-medium">Features</span>
          </div>

          <div className="flex gap-5">
          <div className="flex gap-1.5 px-3 py-1 border border-neutral-300 rounded-md bg-white items-center">9:14 AM</div>
          <div className="flex gap-1.5 px-3 py-1 border border-neutral-300 rounded-md bg-white items-center"><LuCloudSun size={18}/> Lagos</div>
          </div>
        </div>

        {/* Canvas */}
        <div className="flex h-full border border-neutral-300 bg-white rounded-lg"></div>
